...
export default function Propsdemo({ title }: BaseProps) {
  ...
  return (
    <>
      ...
      <Profile name="Buan0001" email="buan0001@kea.dk" isActive={true} singleLine={showHorizontal} />
      <Profile name="melaaa" email="metlatkea@email.com" isActive={false} singleLine={showHorizontal} />
